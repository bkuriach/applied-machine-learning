import LogisticRegression.src.dataset as dataset
import LogisticRegression.src.logisticregression as lr
import numpy as np
...
logReg.predict_sentiment("I did not like this movie")
logReg.predict_sentiment("I would like to see more movies like this")
